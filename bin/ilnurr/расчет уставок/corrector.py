    ...
    while usl1 is True:
        ...
        while usl2 is True:
            ...
            if nextTerminalID == []: #  ---- первый вход в цикл while, где берется терминал источника
                ...
                #    [ ]    <- в роли элемента выступает источник
                ...
                if len(nextTerminalID) > 1:
                    forgottenTerminalID += (nextTerminalID[1:]) #   ---- Если терминалов несколько, хапаем их в список (все, кроме первого - с первым работаем)
