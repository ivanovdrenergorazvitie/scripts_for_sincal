...
try:
    layout = [
        ...
        [sg.Text('Введите к каким узлам необходимо добавить элементы в формате SQL запроса'), sg.InputText("SELECT * FROM Node WHERE Name NOT LIKE '%ПС%' AND Name NOT LIKE '%N%'AND Name NOT LIKE 'РП%' AND Name NOT LIKE '0%' AND Name NOT LIKE '1%' AND Name NOT LIKE '2%' AND Name NOT LIKE '3%' AND Name NOT LIKE '4%' AND Name NOT LIKE '5%' AND Name NOT LIKE '6%' AND Name NOT LIKE '7%' AND Name NOT LIKE '8%' AND Name NOT LIKE '9%'")],
    ...
    while True:                             # The Event Loop
        ...
        if event in ('Submit'):
            ...
            a = cursorObj.execute(a).fetchall()
            b = []
...
>>>>>>> a3f160612a3ae45eab5604ac5cd96bdbd46bb528
